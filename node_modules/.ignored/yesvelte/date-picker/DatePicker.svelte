...
export let componentName = "date-picker";
export let formatText = void 0;
...
$:
  if (value) {
    ...
    if (range) {
      ...
      text = format(value[0], "text") + " - " + format(value[1], "text");
    } else {
   ...
   <path d="M13 7l5 5l-5 5"></path>
      ...
      picker.on("selected", (date1, date2) => {
        if (range) {
          ...
          if (value[0] === startDateValue && value[1] === endDateValue)
            return;
